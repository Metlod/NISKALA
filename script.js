...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const closeImageBtn = document.getElementById('closeImageBtn'); // New Button
    ...
    resetBtn.addEventListener('click', () => {
        ...
        outputImage.classList.add('hidden');
        outputImage.src = "";
        closeImageBtn.classList.add('hidden'); // Also hide close button
        placeholderText.classList.remove('hidden');
    ...
    function renderHistoryItem(item, prepend) {
        ...
        div.querySelector('.view-btn').addEventListener('click', () => {
            ...
            closeImageBtn.classList.remove('hidden'); // Show close button
    ...
    async function generateImage() {
        ...
        outputImage.classList.add('hidden');
        closeImageBtn.classList.add('hidden'); // Hide close button while loading
        placeholderText.classList.add('hidden');
