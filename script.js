    ...
    function renderHistoryItem(item) {
        ...
        div.innerHTML = `
            <div class="aspect-square rounded-lg overflow-hidden bg-[#0f121d] relative">
                ...
                <div class="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition flex flex-col items-center justify-center gap-3 backdrop-blur-sm">
                    <button class="view-btn text-[9px] font-bold uppercase tracking-widest text-white hover:text-[#8b5cf6] transition flex items-center gap-2">
                        <i class="fa-solid fa-eye text-lg"></i> View
                    </button>
                    <button class="delete-btn text-[9px] font-bold uppercase tracking-widest text-red-500 hover:text-red-400 transition flex items-center gap-2">
